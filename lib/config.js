...
const checkDeps_1 = require("./checkDeps");
const isPackageInstalled_1 = require("./isPackageInstalled");
const restrictedGlobals_1 = require("./restrictedGlobals");
(0, checkDeps_1.checkDeps)();
exports.config = {
    settings: {},
    ...
    rules: {
        ...
        'no-restricted-globals': ['warn', ...restrictedGlobals_1.restrictedGlobals],
...
if ((0, isPackageInstalled_1.isPackageInstalled)('react')) {
    exports.config.settings.react = { version: 'detect' };
    exports.config.extends.push('plugin:react/recommended', 'plugin:react/jsx-runtime', 'plugin:react-hooks/recommended');
    Object.assign(exports.config.rules, {
...
if ((0, isPackageInstalled_1.isPackageInstalled)('typescript')) {
    exports.config.extends.push('plugin:@typescript-eslint/recommended');
    exports.config.parser = '@typescript-eslint/parser';
    exports.config.plugins.push('@typescript-eslint');
    Object.assign(exports.config.rules, {
    ...
    Object.assign(exports.config.overrides.find((override) => override.files === '**/*.js')?.rules, {
        '@typescript-eslint/consistent-type-definitions': 'off',
        '@typescript-eslint/explicit-function-return-type': 'off',
        '@typescript-eslint/no-unused-vars': 'off',
        'no-unused-vars': ['warn', { ignoreRestSiblings: true }],
    });
    exports.config.overrides.push({
        files: '**/*.d.ts',
        rules: { 'import/no-default-export': 'off' },
    });
}
if ((0, isPackageInstalled_1.isPackageInstalled)('react') && (0, isPackageInstalled_1.isPackageInstalled)('typescript')) {
    exports.config.rules['react/prop-types'] = 'off';
}
if ((0, isPackageInstalled_1.isPackageInstalled)('jest')) {
    ...
    exports.config.overrides.push({
        ...
        rules: {
            'no-restricted-globals': [
                'warn',
                ...restrictedGlobals_1.restrictedGlobals,
...
if ((0, isPackageInstalled_1.isPackageInstalled)('next')) {
    exports.config.overrides.push({
        files: 'pages/**',
        rules: { 'import/no-default-export': 'off' },
    }, {
...
if ((0, isPackageInstalled_1.isPackageInstalled)('rollup')) {
    exports.config.overrides.push({
...
if ((0, isPackageInstalled_1.isPackageInstalled)('@storybook/core')) {
    exports.config.overrides.push({
        files: '**/*.stories.tsx',
        rules: { 'import/no-default-export': 'off' },
    }, {
